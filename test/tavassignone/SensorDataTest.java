...
public class SensorDataTest {
    ...
    public void testIsValidStream() throws IOException {
        ...
        byte[][] tc = {//array of test cases
            {5, 63, -32, 0, 0, 0, 0, 0, 0, -122, 64, 8, 0, 0, 0, 0, 0, 0, 7, 64, 29, 0, 0, 0, 0, 0, 0, -120},
            {5, 63, -32, 0, 0, 0, 0, 0},
            {105, 63, -32, 0, 0, 0, 0, 0, 0, -122, 64, 8, 0, 0, 0, 0, 0, 0, 7, 64, 29, 0, 0, 0, 0, 0, 0, -120},
            {5, 63, -32, 0, 0, 0, 0, 0, 0, 6, 64, 8, 0, 0, 0, 0, 0, 0, 7, 64, 29, 0, 0, 0, 0, 0, 0, -120},
            {5, 63, -32, 0, 0, 0, 0, 0, 0, 13, 64, 8, 0, 0, 0, 0, 0, 0, 7, 64, 29, 0, 0, 0, 0, 0, 0, -120},
            {5, 63, -32, 0, 0, 0, 0, 0, 0, -122, 64, 8, 0, 0, 0, 0, 0, 0, -121, 64, 29, 0, 0, 0, 0, 0, 0, -120},
            {5, 63, -32, 0, 0, 0, 0, 0, 0, -122, 64, 8, 0, 0, 0, 0, 0, 0, 111, 64, 29, 0, 0, 0, 0, 0, 0, -120},
            {5, 63, -32, 0, 0, 0, 0, 0, 0, -122, 64, 8, 0, 0, 0, 0, 0, 0, 7, 64, 29, 0, 0, 0, 0, 0, 0, 8},
            {5, 63, -32, 0, 0, 0, 0, 0, 0, -122, 64, 8, 0, 0, 0, 0, 0, 0, 7, 64, 29, 0, 0, 0, 0, 0, 0, 34}
        };
